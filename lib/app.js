...
(function (NeoTest) {
    class Menu {
        ...
        start() {
            ...
            this.addMenuItem(new NeoTest.Test_Nep2());
            this.addMenuItem(new NeoTest.Test_Nep2_sign());
...
(function (NeoTest) {
    ...
    NeoTest.Test_Nep2 = Test_Nep2;
})(NeoTest || (NeoTest = {}));
var NeoTest;
(function (NeoTest) {
    class Test_Nep2_sign {
        constructor() {
        }
        getName() {
            return "Nep2_sign";
    ...
    NeoTest.Test_Nep2_sign = Test_Nep2_sign;
})(NeoTest || (NeoTest = {}));
