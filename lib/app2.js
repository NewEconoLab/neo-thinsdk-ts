...
(function (NeoTest2) {
    class Menu {
        ...
        start() {
            ...
            this.addMenuItem(new NeoTest2.Test1_Fullog_SimVM());
            this.addText("==avm相关==");
            this.addMenuItem(new NeoTest2.Test2_AVM_Read());
            this.addMenuItem(new NeoTest2.Test2_Map_Read());
        }
        addText(str) {
...
(function (NeoTest2) {
    class Test1_Fullog_SimVM {
        ...
        addtxtSub(str) {
            ...
            span.textContent = str;
            this.divInfo.appendChild(document.createElement("hr"));
        }
        testasync() {
            return __awaiter(this, void 0, void 0, function* () {
                let lzma = new nid.LZMA();
                this.addtxt("new LZMA");
                var result = yield fetch("res/0xd8cb60829a67d1628160ab1b32b009248460105ee932ea721b072c31dccbbc5b.llvmhex.txt", { "method": "get" });
                var hexstr = yield result.text();
                var srcbytes = hexstr.hexToBytes();
                this.addtxt("get llvmhex.");
    ...
    NeoTest2.Test1_Fullog_SimVM = Test1_Fullog_SimVM;
})(NeoTest2 || (NeoTest2 = {}));
var NeoTest2;
(function (NeoTest2) {
    class Test1_Lzma {
...
(function (NeoTest2) {
    class Test2_AVM_Read {
        ...
        testasync() {
            return __awaiter(this, void 0, void 0, function* () {
                var result = yield fetch("res/nns_domaincenter.avm.bin", { "method": "get" });
                var hex = new Uint8Array(yield result.arrayBuffer());
                this.addtxt("get .avm.");
                try {
    ...
    NeoTest2.Test2_AVM_Read = Test2_AVM_Read;
})(NeoTest2 || (NeoTest2 = {}));
var NeoTest2;
(function (NeoTest2) {
    class Test2_Map_Read {
        constructor() {
        }
        getName() {
        ...
        testasync() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                var result = yield fetch(filename + ".avm.bin", { "method": "get" });
                var hex = new Uint8Array(yield result.arrayBuffer());
                this.addtxt("get .avm.");
                var result2 = yield fetch(filename + ".map.json", { "method": "get" });
                var mapstr = yield result2.text();
                this.addtxt("get .map.json.");
                var result3 = yield fetch(filename + ".cs.txt", { "method": "get" });
                var lines = (yield result3.text()).split('\n');
                ...
                if (oplist != null) {
                    for (var i = 0; i < oplist.length; i++) {
                        var op = oplist[i];
                        var line = addr.GetLineBack(op.addr);
                        console.log(op.addr);
    ...
    NeoTest2.Test2_Map_Read = Test2_Map_Read;
})(NeoTest2 || (NeoTest2 = {}));
