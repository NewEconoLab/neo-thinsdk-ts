...
(function (NeoTest2) {
    class Menu {
        ...
        start() {
            ...
            this.addText("==avm相关==");
            this.addMenuItem(new NeoTest2.Test3_Codemirror_CursorControl());
        }
        addText(str) {
...
var NeoTest2;
(function (NeoTest2) {
    class Test3_Codemirror_CursorControl {
        constructor() {
            this.stackarr = [];
        }
        getName() {
        ...
        debug() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.stackarr[codeline]) {
                    ...
                    yield this.initCode(script.hash);
                    let index = this.oplist[codeline];
                    var line = this.addr.GetLineBack(op.addr);
        ...
        initCode(hash) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                this.codeEditor.setValue(yield result3.text());
            });
        }
        testasync() {
            return __awaiter(this, void 0, void 0, function* () {
    ...
    NeoTest2.Test3_Codemirror_CursorControl = Test3_Codemirror_CursorControl;
    class AvmInfo {
    }
})(NeoTest2 || (NeoTest2 = {}));
