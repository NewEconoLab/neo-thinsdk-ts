    ...
    class Test3_Codemirror_CursorControl {
        ...
        start(div) {
            ...
            this.fulllogEditor.on("cursorActivity", (res) => {
                ...
                if (this.stackarr[codeline]) {
                    ...
                    var line = this.addr.GetLineBack(index.addr);
        ...
        testasync() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                var result = yield fetch("res/0xf8f8abba3c1c40429640868368cff6f160910ddefec44ea4a372dd3cc0710394.llvmhex.txt", { "method": "get" });
